...
class WebsiteMetricsCollector:
    def __init__(self):
        self.website_traffic_value = Gauge(
            ...
            ['date', 'cdn'] #the labels that metric have
        )
    ...
    def _fetch_cdnetworks_data(self, cdn_name, domains_for_url, user_package, start_date_str, end_date_str):
        ...
        class Client:
            ...
            def main():
                ...
                return flow_data[6:-1] if flow_data else []
        return Client.main()
                ...
                if usage_data:
                    ...
                    for entry in usage_data:
                        ...
                        if cdn_name.startswith(("huawei")):
                            ...
                            self.website_traffic_value.labels(date=date, cdn=cdn_name).set(value_in_tb)
                            ...
                            self.website_traffic_value.labels(date=date, cdn=cdn_name).set(value_in_gb)
